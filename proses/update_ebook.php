...
else $query = "UPDATE upload SET name='$fileName',temp='$tmpName', size='$fileSize', type='$fileType', judul='$judul', pengarang='$pengarang', penerbit='$penerbit'
		, thnterbit='$thnterbit', tebal='$tebal', isbn='$isbn', kategori='$kategori', bahasa='$bahasa', ikhtisar='$ikhtisar'WHERE id='$_POST[id]'";
