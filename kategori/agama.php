...
font-family: verdana;
text-shadow: #fff 0 1px 0;"> DATA EBOOK </h2>
      <div style="margin:auto auto 70px;">
            <div class="rounded_3 shadow_3 content">
                    ...
                    <tbody>
						...
						include("../koneksi.php");
                        $sql = "select * from upload where kategori = ' Agama' limit $start, $per_page";
                        ...
                        if ($i % 2 == 0) {
							...
							echo "<p><a href='agama_lihat.php?id=" . $data['id'] . "'>Lihat</a></p>";
